...
def run_emotional_dip_scan(progress_callback=None, index: str = "sp500") -> List[Dict]:
    ...
    Args:
        ...
        index: 'sp500', 'russell2000', 'etfs', or 'velocity' (Leveraged high-conviction universe)
    ...
    index_name = "S&P 500" if index == "sp500" else ("ETFs" if index == "etfs" else ("Russell 2000" if index == "russell2000" else "Leveraged (high-conviction)"))
